...
//			Utils.passedTestLog("Service is added sucessfully");
    ...
    public void agentAddLeaseRegistrationService() throws Exception {
        //ExtentReportSetup.test = ExtentReportSetup.createtheTest("Adding a Service");
        try {
            WebActions.clickOn(servicesTabLocators, "addServicesButton");
            WebActions.setWaitTime(1000);
...
//            WebActions.performTab(1);
            ...
            WebActions.setWaitTime(2000);
            System.out.println("date place came");
            WebActions.JSclickOn(servicesTabLocators, "LeaseEffectiveDate");
            WebActions.setWaitTime(1000);
            WebActions.performEnter(1);
            WebActions.JSclickOn(servicesTabLocators, "LeaseExpiryDate");
            WebActions.setWaitTime(1000);
            WebActions.performRightArrow(20);
            WebActions.performEnter(1);
            //typebox - error
//        WebActions.clickOn(servicesTabLocators, "typeBox");
//        WebActions.enterTextOn(servicesTabLocators, "filterBox",
...
//        System.out.println("validation");
            ...
            WebElement validateBtn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[@class='mat-mdc-focus-indicator'])[2]")));
            System.out.println("Validate button is visible.");
            WebActions.JSclickOn(servicesTabLocators, "LeaseValidateButton");
            WebActions.setWaitTime(3000);
            String actualValidationSucessMsg = WebActions.getElementText(servicesTabLocators, "ServiceValidationSucessMsg");
            String expectedValidationSucessMsg = JSONReader.getJSONDataBlockKey("ServiceData", "LeaseValidation", "validationSucessMsg");
            System.out.println("actualValidationSucessMsg" + actualValidationSucessMsg);
            System.out.println("expectedValidationSucessMsg" + expectedValidationSucessMsg);
            if (actualValidationSucessMsg.equals(expectedValidationSucessMsg)) {
                Utils.stepInfoLog("Matched validation message is found : \" Expected : \"" + expectedValidationSucessMsg + "\" and Actual : \"" + actualValidationSucessMsg + "\" are equal");
...
//        WebActions.JSclickOn(servicesTabLocators, "ServiceValidationCloseButton");
    ...
    public void agentAddTransferOfOwnershipService() throws Exception {
        //ExtentReportSetup.test = ExtentReportSetup.createtheTest("Adding a Service");
        try {
            WebActions.clickOn(servicesTabLocators, "addServicesButton");
            WebActions.setWaitTime(1000);
...
//            WebElement validateBtn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[@class='mat-mdc-focus-indicator'])[2]")));
//            System.out.println("Validate button is visible.");
            WebActions.JSclickOn(servicesTabLocators, "TransferOfOwnershipValidateButton");
            WebActions.setWaitTime(3000);
            String actualValidationSucessMsg = WebActions.getElementText(servicesTabLocators, "ServiceValidationSucessMsg");
            String expectedValidationSucessMsg = JSONReader.getJSONDataBlockKey("ServiceData", "TransferOfOwnershipValidation", "validationSucessMsg");
            System.out.println("actualValidationSucessMsg" + actualValidationSucessMsg);
            System.out.println("expectedValidationSucessMsg" + expectedValidationSucessMsg);
            if (actualValidationSucessMsg.equals(expectedValidationSucessMsg)) {
                Utils.stepInfoLog("Matched validation message is found : \" Expected : \"" + expectedValidationSucessMsg + "\" and Actual : \"" + actualValidationSucessMsg + "\" are equal");
...
//          WebActions.JSclickOn(servicesTabLocators, "ServiceValidationCloseButton");
    ...
    public void agentValidatesAndLodgeApplication() throws Exception {
        try {

            WebActions.JSclickOn(servicesTabLocators, "validateButtom");
            WebActions.setWaitTime(3000);
            String actualValidationSucessMsg = WebActions.getElementText(servicesTabLocators, "ApplicationValidationSucessMsg");
            String expectedValidationSucessMsg = JSONReader.getJSONDataBlockKey("ServiceData", "LodgeApplication", "applicationValidationSucessMsg");
            System.out.println("actualValidationSucessMsg" + actualValidationSucessMsg);
            System.out.println("expectedValidationSucessMsg" + expectedValidationSucessMsg);
            if (actualValidationSucessMsg.equals(expectedValidationSucessMsg)) {
                Utils.stepInfoLog("Matched validation message is found : \" Expected : \"" + expectedValidationSucessMsg + "\" and Actual : \"" + actualValidationSucessMsg + "\" are equal");
            ...
            WebActions.setWaitTime(2000);
            WebActions.clickOn(servicesTabLocators, "passwordConfirm");
            String Password = YamlLoader.getUserNameAndPasswordFromYamlBasedOnURL(yamlFileName, "Agent", "Agent_password");
            WebActions.enterTextOn(servicesTabLocators, "passwordConfirm", WebActions.decodeTheGivenValue(Password));
