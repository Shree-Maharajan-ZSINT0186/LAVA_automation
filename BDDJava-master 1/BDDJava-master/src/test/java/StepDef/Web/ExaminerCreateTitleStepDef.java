...
public class ExaminerCreateTitleStepDef extends FakerClassLibrary{
    ...
    public void launchTheApplication() throws Throwable {
        ...
        try {
            ...
            WebActions.enterTextOn(ExaminerLoginLocators, "agentUsernameTextbox", userName);
            WebActions.enterTextOn(ExaminerLoginLocators, "agentPasswordTextbox", Password);
            ...
            boolean HomeDashboardPageTitle = WebActions.isElementDisplayed(ExaminerLoginLocators, "homeDashboardPage");
            String HomeDashboardPageTitleText = WebActions.getElementText(ExaminerLoginLocators, "homeDashboardPage");
